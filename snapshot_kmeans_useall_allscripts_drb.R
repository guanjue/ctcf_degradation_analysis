...
for (i in c(1:length(tp_type))){
	...
	### plot original
	plot(d_nonpk_average_mat_FC_i_ref, d_nonpk_average_mat_FC_i_tar, pch=16, col='gray', xlim=c(lim_min_chipseq, lim_max_chipseq), ylim=c(lim_min_chipseq, lim_max_chipseq), main = main_title, log='xy')
	for (j in c(1:dim(d_chipseq_mat_FC_tmp)[2])){
	...
	### plot TSnorm
	plot(d_nonpk_average_mat_FC_i_ref, d_nonpk_average_mat_FC_i_tar_TSnorm, pch=16, col='gray', xlim=c(lim_min_chipseq, lim_max_chipseq), ylim=c(lim_min_chipseq, lim_max_chipseq), main = main_title, log='xy')
	...
	### plot s3norm
	plot(d_nonpk_average_mat_FC_i_ref, d_nonpk_mat_FC_i_tar_s3norm, pch=16, col='gray', xlim=c(lim_min_chipseq, lim_max_chipseq), ylim=c(lim_min_chipseq, lim_max_chipseq), main = main_title_s3, log='xy')
	for (j in c(1:dim(d_chipseq_mat_FC_i_s3norm_mat)[2])){
