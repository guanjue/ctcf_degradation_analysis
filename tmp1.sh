...
do
	...
	paste $id'.allmerged.sorted.signal.1.tab' $id'.allmerged.sorted.signal.macsBG.tab' | awk -F '\t' -v OFS='\t' '{if ($1/$2>=1) print $1/$2; else print 1}' > $id'.allmerged.sorted.signal.fc.tab'
