...
AB_1_used = AB_1_mat
AB_2_used = AB_2_mat
AB_average_used = AB_average_mat

AB_1_used = AB_TS1_mat
AB_2_used = AB_TS2_mat
AB_average_used = AB_TSaverage_mat
...
for (i in c(1:6)){
	...
	rep1_sig_s3norm = (rep1_sig_fc)^AB_1_i[2] * AB_1_i[1]
	rep2_sig_s3norm = (rep2_sig_fc)^AB_2_i[2] * AB_2_i[1]
	...
	rep1_sig_s3norm_qtpcr = (rep1_sig_fc_qtpcr)^AB_1_i[2] * AB_1_i[1]
	rep2_sig_s3norm_qtpcr = (rep2_sig_fc_qtpcr)^AB_2_i[2] * AB_2_i[1]
...
colnames(rep1_sig_s3norm_mat) = sample_list[seq(1,12,2),3]
colnames(rep2_sig_s3norm_mat) = sample_list[seq(1,12,2),3]
