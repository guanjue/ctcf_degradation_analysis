...
signal_mat_index_od = as.matrix(read.table('signal_mat_index_vec_ic.txt', header=F))
signal_mat_index = signal_mat_index_od

### read all index
index_count_table = as.matrix(read.table('index_count_enrich_ic.txt', header=F))
...
write.table(predicted_index_output, 'signal_mat_index_vec_ic_ic.txt', quote=FALSE, col.names=FALSE, row.names=FALSE, sep='\t')
write.table(index_count_new_nosmall, 'index_count_enrich_ic_ic.txt', quote=FALSE, col.names=FALSE, row.names=TRUE, sep='\t')
