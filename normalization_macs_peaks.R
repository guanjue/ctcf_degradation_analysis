...
for (i in c(1:6)){
	...
	### read nopeak
	rep1_nopk = paste(sample_list[rep1_i, 1], '.mm9_500.sorted.rc_per_bp.tab', sep='')
	rep2_nopk = paste(sample_list[rep2_i, 1], '.mm9_500.sorted.rc_per_bp.tab', sep='')
	input_nopk = paste(sample_list[rep1_i, 2], '.mm9_500.input_sig.macs.tab', sep='')
	### read data
